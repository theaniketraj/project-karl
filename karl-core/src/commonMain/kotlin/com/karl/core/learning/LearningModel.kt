 ...
 *
 * This abstraction allows a LearningEngine implementation (like `:karl-kldl`) to be designed to
 * work with different model architectures (e.g., MLP, RNN, Transformer) that conform to this
 * contract. It defines the essential operations of a model: prediction, training, and state
 * management.
 */
