...
//    id("org.gradle.build-cache")
    id("org.jetbrains.compose") version "1.7.3" apply false // Apply false means modules apply it explicitly
...
val composeVersion = "1.7.3" // Should match the plugin version or compatible
