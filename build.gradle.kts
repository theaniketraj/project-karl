...
//    id("org.gradle.build-cache")
    ...
    id("org.jetbrains.kotlin.jvm") version "2.1.21" apply false // Apply false means modules apply it explicitly
    // kotlin("jvm") apply false // Apply false means modules apply it explicitly (used by example app) //
    kotlin("multiplatform") version "2.1.21" apply false // Apply false means modules apply it explicitly (used by core, kldl)
...
val kotlinVersion = "2.1.21" // Or whatever your current Kotlin version is
